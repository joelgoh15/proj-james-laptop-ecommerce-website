<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseList.aspx.cs" Inherits="Portfolio2_3.AdminPage" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Purchase List Page</title>
    <meta charset="utf-8" />
    <style type="text/css">
        ...
        .classALinkPurchaseList:hover ,a.classALinkAbout:hover { 
            background-color: lightgray;
            color:navy;
            margin-left:5px;
