                                    ...
                                    <table class="classTableCheckoutForm">
                                        ...
                                        <tr>
                                            <td class="classTdRowCheckoutButton">
                                                ...
                                                <asp:LinqDataSource ID="CheckoutLinqDataSource" runat="server" ContextTypeName="project7_4.AppDB_DataClassesDataContext" EntityTypeName="" TableName="CheckoutTables" EnableInsert="True"></asp:LinqDataSource>
                                                <%--<asp:LinqDataSource ID="CheckoutLinqDataSource" runat="server"></asp:LinqDataSource>--%>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
